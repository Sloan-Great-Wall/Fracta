...
echo ""
echo "=== Copying to SwiftPM package ==="
SWIFTPM_FRAMEWORKS="$APPLE_DIR/Fracta.swiftpm/Frameworks"
mkdir -p "$SWIFTPM_FRAMEWORKS"
rm -rf "$SWIFTPM_FRAMEWORKS/FractaFFI.xcframework"
cp -R "$FRAMEWORKS_DIR/FractaFFI.xcframework" "$SWIFTPM_FRAMEWORKS/"

echo ""
echo "=== Done! ==="
echo "XCFramework created at: $FRAMEWORKS_DIR/FractaFFI.xcframework"
echo "Also copied to: $SWIFTPM_FRAMEWORKS/FractaFFI.xcframework"
ls -la "$SWIFTPM_FRAMEWORKS/FractaFFI.xcframework"
